...
New Zealand MMP feasibility is now proven by the `New Zealand General 2023` integration:
...
- Port Waikato remains cancelled in the general election rather than being merged with the later by-election

The next New Zealand extension can reuse this foundation for the 2020 general election.
