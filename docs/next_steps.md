...
Tasmania House of Assembly feasibility is now proven by the `Tasmania State 2025` and `Tasmania State 2024` integrations:
...
- the app now treats Tasmanian divisions as seven-member contests and shows elected member lists, party seat splits, quota, and last-seat gaps
- the boundary file can be generated by filtering the existing AEC March 2025 national federal division boundaries to Bass, Braddon, Clark, Franklin, and Lyons
